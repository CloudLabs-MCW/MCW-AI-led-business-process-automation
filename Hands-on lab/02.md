...
5. Return to the lab resource group and select the Cognitive Service named **contoso-textanalytics-SUFFIX** in your lab resource group.
   ...
   ![Lab resource group is open. The Cognitive Service Text Analytics resource is highlighted.](media/contoso-text-analytics.png "Cognitive Service Text Analytics Resource Selection")
